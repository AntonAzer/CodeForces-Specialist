...
*   Also don't forget LeetCode as I mentioned in point two in [Shortcuts_and_Mindset.md](https://github.com/AntonAzer/CodeForces-Specialist/blob/main/Shortcuts_and_Mindset.md).
